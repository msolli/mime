...
Devise.setup do |config|
  ...
  config.mailer_sender = "no-reply@ableksikon.no"
  ...
  config.pepper = "81fa7b38ca301ce14b1041b3ce174d3eef46d94a27f33f872b6eed5f801b4ced955bb5613d96ac045d34c205dfd8ed07fd98733f9d9dcace39c0ef25b6fcfcd8"

  # ==> Configuration for :token_authenticatable
  # Defines name of the authentication token params key
  config.token_authentication_key = :authId
